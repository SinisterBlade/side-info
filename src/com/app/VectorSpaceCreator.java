...
/**
 * Class to create a vector to be used for clustering
 * @author Rajat
 *
 */
public class VectorSpaceCreator {
	...
	/**
	 * 
	 * @param original Original string from which vector is to be created
	 */
	...
	/**
	 * Create vector space by splitting the original string and removing stop words
	 * @return Created vector space
	 */
